...
// Shared <svg> attributes. Spread last so a caller can override any of them.
const iconAttrs = (props: IconProps) => ({
  width: 24,
  height: 24,
  viewBox: "0 0 24 24",
  fill: "none",
...
export const VideoCamIcon = (props: IconProps) => (
  <svg {...iconAttrs(props)}>
    <rect x="2" y="6" width="13" height="12" rx="2.5" />
    <path d="M15 10.5 21.2 7.2a.6.6 0 0 1 .9.5v8.6a.6.6 0 0 1-.9.5L15 13.5Z" />
  </svg>
...
export const PhoneEndIcon = (props: IconProps) => (
  <svg {...iconAttrs(props)}>
...
// The one filled icon. It cannot use iconAttrs, which sets fill="none" and a
// stroke, so it spells out the attributes it needs instead.
